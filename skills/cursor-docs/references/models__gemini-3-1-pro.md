---
title: "Models Gemini 3 1 Pro"
source: https://cursor.com/docs/models/gemini-3-1-pro
path: /docs/models/gemini-3-1-pro
---
...
Cursor [plans](https://cursor.com/docs/models-and-pricing.md) include two usage pools. Gemini 3.1 Pro draws from the third-party **Other Models** pool, which charges at the rates below. All prices are per million tokens.
